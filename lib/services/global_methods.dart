...
class GlobalMethods {
  static String formattedText(String publishedAt) {
    ...
    return "${publishedDate.day}/${publishedDate.month}/${publishedDate.year} --- ${publishedDate.hour}:${publishedDate.minute}/${publishedDate.second}";
  }
